...
\marginnote{Note that low-powered firewalls may only filter the first syn packets. Syn-ack cookies can pose a problem for them since our network flow may establish a connection much further down from the initial syn packet}
...
One way to exploit DNS servers is to \textit{poison} their cache:
